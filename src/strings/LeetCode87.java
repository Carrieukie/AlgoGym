    ...
    public static boolean isScramble(String s1, String s2, Map<String, Boolean> mp) {
        ...
        for (int i = 1; i < n; i++) {
            ...
            boolean withoutswap = (
                    ...
                    isScramble(s1.substring(0, i), s2.substring(0, i), mp)

                            &&

                            // right part of first and second string;
                            isScramble(s1.substring(i), s2.substring(i), mp)
            );
            ...
            boolean withswap = (
                    ...
                    isScramble(s1.substring(0, i), s2.substring(n - i), mp)

                            &&

                            // right part of first and left part of second
                            isScramble(s1.substring(i), s2.substring(0, n - i), mp)
            );
